...
const saleSchema = new mongoose.Schema(
  {
    ...
    patient: { type: ObjectId, ref: "Patient", required: false},

    createdBy: { type: ObjectId, ref: "User", required: true},

    items: { type: [saleItemSchema], required: true, validate: {   validator: (items) => items.length > 0,   message:     "Sale must contain at least one medicine", }},

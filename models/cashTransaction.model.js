...
const cashTransactionSchema =
  new mongoose.Schema(
    {
      cashDrawer: { type: ObjectId, ref: "CashDrawer", required: true, index: true},
      type: { type: String, enum: ["income", "expense"], required: true},
      source: { type: String, enum: [   "operation_payment",   "doctor_settlement",   "sale_payment",   "visit_payment",   "expense",   "refund",   "other", ], required: true},
